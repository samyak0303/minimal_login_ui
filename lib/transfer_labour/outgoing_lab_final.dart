...
class OutgoingLabourf extends StatefulWidget {
  const OutgoingLabourf({super.key});

  @override
  State<OutgoingLabourf> createState() => _OutgoingLabourfState();
}

class _OutgoingLabourfState extends State<OutgoingLabourf> {
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                              onPressed: _transferController.clear,
                              icon: Icon(Icons.clear)),
                        ),
                      ),
                    ),
